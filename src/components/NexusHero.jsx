  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center px-6 text-center max-w-4xl mx-auto">
        <span
          className={`label-mono mb-8 text-[10px] text-[#0a0a0c]/55 transition-opacity duration-1000 ${
        ...
        <h1
          className={`font-heading text-5xl font-medium leading-[0.95] tracking-[-0.02em] text-[#0a0a0c] sm:text-7xl md:text-8xl transition-all duration-1000 ${
            mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
          EXPLORE THE <br />
          <span className="italic font-normal text-[#0a0a0c]/70">uncharted</span>{' '}
          universe.
        </h1>

        <p
          className={`mt-8 max-w-md font-mono text-sm leading-relaxed text-[#0a0a0c]/60 transition-all delay-200 duration-1000 ${
            mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
        ...
        >
          <span className="label-mono text-[10px] text-[#0a0a0c]/70 group-hover:text-[#0a0a0c]">
            Begin Discovery
          </span>
          <span className="h-px w-12 bg-[#0a0a0c]/40 transition-all duration-300 group-hover:w-20 group-hover:bg-[#0a0a0c]" />
        </a>
      </div>

      <div className="absolute bottom-6 left-1/2 z-20 -translate-x-1/2">
        <span className="label-mono text-[8px] text-[#0a0a0c]/40">SCROLL ↓</span>
      </div>
    </section>
  );
}
